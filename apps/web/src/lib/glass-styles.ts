export const glassOuter =
  "@container rounded-lg bg-card/60 p-1.5 ring-1 ring-border transition-[transform,box-shadow] duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-0.5 hover:shadow-md";
...
export const glassInner =
  "rounded-[inherit] bg-card/80 shadow-[inset_0_1px_1px_color-mix(in_oklch,var(--foreground)_6%,transparent)]";
