    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[70] flex justify-end p-4 md:p-6">
      <div className="pointer-events-auto flex flex-col items-end gap-3">
        {open ? (
          <aside
            className={cn(
              "w-[min(calc(100vw-2rem),20.5rem)] overflow-hidden rounded-2xl",
          ...
          >
            ...
            <div className="space-y-4 px-4 py-3.5">
              ...
              <p className="border-t border-white/[0.06] pt-3 font-mono text-[11px] leading-relaxed text-muted-foreground">
                senha {SEED_PASSWORD}
                <br />
                api {getApiBaseUrl()}
              </p>
        ...
        <button
          ...
          className={cn(
            ...
            "transition-[transform,background-color] hover:bg-white/[0.06] active:scale-[0.98]",
          )}
          aria-expanded={open}
