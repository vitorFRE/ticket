export function EventDetailSkeleton() {
  return (
    <div className="relative min-h-[calc(100dvh-3.5rem)] overflow-hidden bg-white/[0.03]">
      <div className="mx-auto flex min-h-[calc(100dvh-3.5rem)] max-w-6xl flex-col justify-end px-4 pb-12 pt-8 md:px-6 md:pb-16 lg:px-8">
